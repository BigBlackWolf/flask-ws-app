// Example from https://github.com/miguelgrinberg/socketio-examples/blob/master/audio/static/audio/main.js
...
var socketio = io.connect(location.origin + '/stream', {transports: ['websocket']});
...
function toggleRecording( e ) {
    if (e.classList.contains('recording')) {
        ...
        recording = true;
        socketio.emit('start_record', {channels: 1, bps: 16, fps: parseInt(audioContext.sampleRate)});
    }
}
